#!/usr/bin/python3.2
import sys
sys.path.append('/home/kevin/Downloads/Jarvis/JarvisMail')
...
infile = open('/home/kevin/Downloads/Jarvis/JarvisMail/jmail_new_messages.dat','rb')
...
outfile = open('/home/kevin/Downloads/Jarvis/JarvisMail/jmail_new_messages.dat','wb')
...
def getjmail(querryfilename):
    import pickle
    messages_file_name = '/home/kevin/Downloads/Jarvis/JarvisMail/jmail_new_messages.dat'
